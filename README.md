...
Opus 48 kbps preview MP3s for the **karoryfer.HorsePulse** sample library.
...
```
https://raw.githubusercontent.com/zulfikarbarbora-outl/horse-pulse-opus-48/main/<filename>.opus
```
